...
class _AddHabitScreenState extends State<AddHabitScreen> {
  ...
  String selectedColorName = 'Amber'; // Nombre de color predeterminado
  ...
  Widget build(BuildContext context) {
    // Combinar ambos mapas para mostrar, asegurando que no haya duplicados
    Map<String, String> allHabitsMap = {...selectedHabitsMap, ...completedHabitsMap};

    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.blue.shade700,
        title: Text('Configurar Hábitos'),
      ),
      body: Padding(
