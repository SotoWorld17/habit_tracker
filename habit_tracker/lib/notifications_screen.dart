    ...
    if (html.Notification.permission != "granted") {
      html.Notification.requestPermission().then((permission) {
        if (permission == 'granted') {
          html.Notification("Recordatorio de Hábitos",
              body: "¡Es hora de trabajar en tus hábitos!");
          print('Permiso de notificación concedido. Notificación enviada.');
        } else {
      ...
      html.Notification("Recordatorio de Hábitos",
          body: "¡Es hora de trabajar en tus hábitos!");
      print('Notificación enviada directamente.');
    }
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Divider(),
            Text(
              'Seleccionar Hábitos para Notificación',
            ...
            SizedBox(height: 20),
            Text(
              'Seleccionar Tiempos para Notificación',
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
            SizedBox(height: 10),
            Wrap(
            ...
            ElevatedButton(
              onPressed: () {
                // Usa el método _sendTestNotification para activar la notificación
                _sendTestNotification();
              },
              child: Text('Enviar Notificación de Prueba'),
